...
model_path = '/home/give/PycharmProjects/MedicalImage/Net/ICIP/4-class/Patch_ROI/160-models'
divided_liver = False
...
if __name__ == '__main__':
    ...
    #             8,
    #             os.path.join(
    #                 '/home/give/Documents/dataset/MedicalImage/MedicalImage/SL_TrainAndVal/heatingmap/ICIP/4-classes/160_patch_ROI',
    #                 subclass
    #             )
    #         )
    ...
    #     scio.savemat('./160-models/mat/'+subclass+'.npy', {
