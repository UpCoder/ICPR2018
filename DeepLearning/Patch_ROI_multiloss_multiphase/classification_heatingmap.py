...
if __name__ == '__main__':
    ...
    train_data = scio.loadmat('./mat/train.npy.mat')
    train_features = train_data['features']
    train_labels = train_data['labels']

    val_data = scio.loadmat('./mat/val.npy.mat')
    val_features = val_data['features']
    val_labels = val_data['labels']

    test_data = scio.loadmat('/home/give/PycharmProjects/ICPR2018/DeepLearning/Patch_ROI_multiloss_multiphase/mat/test.npy.mat')
