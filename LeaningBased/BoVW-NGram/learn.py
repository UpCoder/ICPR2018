...
def generate_dictionary(data_dir='/home/give/Documents/dataset/ICPR2018/BoVW-NGram/data.mat', vocabulary_size=256, limited_num=30000, save_path='./vocabulary.model'):
    ...
    np.save(save_path, kmeans_obj.cluster_centers_)
